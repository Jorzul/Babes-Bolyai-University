...
if __name__ == '__main__':
    ...
    product_repository = GenericRepository(ProductValidator)
    # product_repository = ProductFileRepository("../../../data/products", ProductValidator)
    order_repository = GenericRepository(OrderValidator)
