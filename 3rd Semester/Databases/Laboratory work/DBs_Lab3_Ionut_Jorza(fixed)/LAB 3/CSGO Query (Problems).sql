...
/* The ID of the teams that have a sponsor and the date they play in. */
/* 2 many-to-many relationships */
SELECT Team_Sponsor.Team_ID, [MatchBO1].Match_Date FROM Team_Sponsor
LEFT JOIN [MatchBO1] on ([MatchBO1].Team1_ID = Team_Sponsor.Team_ID or [MatchBO1].Team2_ID = Team_Sponsor.Team_ID)



/* Select all the players, showing which maps they enjoy the most. */
SELECT
	Player.Player_ID, Player.Player_Name,
